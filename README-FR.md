...
| Couverture automatique (même version) | À la publication, une couverture peut être générée automatiquement, pour que Bilibili ne refuse pas une couverture vide. Le détail de la couverture et du carton de titre par défaut suit la notice de cet installeur. Les installeurs publiés de la v1.3.1 ne l’incluent pas. |
