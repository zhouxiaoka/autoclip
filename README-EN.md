...
Editing stays on your device. Cloud model analysis sends transcript text to your selected provider. The finished clip leaves the machine only after you click Publish, and only to the platforms you connected. You can also download it without publishing. That Publish page is in the next installer that includes it; the published v1.3.1 installers do not have it. Analytics and error reporting depend on your version and settings; see the privacy notes.
