...
@server.tool(
    ...
    description=(
        ...
        "provider 可选 dashscope / openai / gemini / deepseek / seed / kimi / glm / grok / ollama / lmstudio；不填用桌面应用里已配置的模型。"
    ),
)
...
def list_providers() -> Dict[str, Any]:
    ...
    return {
        ...
        "cloud": ["dashscope", "openai", "gemini", "deepseek", "seed", "kimi", "glm", "grok"],
