...
| Выбор моделей | Поддерживаются Qwen, OpenAI, Gemini, DeepSeek, Doubao Seed, Kimi, GLM и локальные модели через Ollama / LM Studio (свой API-ключ). |
...
| Вариант | Настройка |
| --- | --- |
| Облачные модели | В настройках выберите Qwen, OpenAI, Gemini, DeepSeek, Doubao Seed, Kimi или GLM и введите API-ключ. Совместимые адреса поддерживают свой Base URL. |
