...
v1.3.0、v1.3.1、v1.3.2 和 v1.3.3 已经发布。八语界面、崩溃上报、应用内更新、发布页、自动封面、应用内反馈汇入 GitHub、失败文案、通义国际站、Docker 设置页、竖屏导出和 CLI / MCP 算 Shipped，写在 Project 简介里，不再开卡。#125 已在 v1.3.2 发行说明里，2026-09-23 收件 workflow 跑通后关卡。
...
- Windows 安装包真机验证（v1.3.3 仍没有干净机器记录）
...
- 1080p60 导出
- 说话人居中裁切（自动封面已在 v1.3.2，这张卡只剩居中裁切）

## 排期

合进 main 和发版是两件事。当前版本停在 **v1.3.3**。之后先把改动合进 main，卡片放到 Building，攒一批再打一个 tag。不为单个反馈单独热修。
