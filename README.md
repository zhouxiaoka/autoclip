...
| 自由选择模型 | 支持通义千问、OpenAI、Gemini、Claude、DeepSeek，以及 Ollama / LM Studio 本地模型（自备 API Key）。 |
...
| 方式 | 配置 |
| --- | --- |
| 云端模型 | 在设置中选择通义千问、OpenAI、Gemini、Claude 或 DeepSeek，填写 API Key；兼容接口可配置 Base URL。 |
