...
| LLM | OpenAI 及 OpenAI 兼容接口（自定义 base_url）/ Gemini / 通义千问(dashscope) / DeepSeek / Seed / Kimi / GLM / Grok / 本地预设 Ollama、LM Studio。设置页不再把硅基流动作为独立提供商 | `backend/core/llm_providers.py`、`llm_manager.py`、`local_presets.py` |
