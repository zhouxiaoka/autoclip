...
| LLM | OpenAI 及 OpenAI 兼容接口（自定义 base_url）/ Gemini / 通义千问(dashscope) / DeepSeek / 豆包 Seed / Kimi / GLM / 本地预设 Ollama、LM Studio | `backend/core/llm_providers.py`、`llm_manager.py`、`local_presets.py` |
