...
export interface Draft {
  ...
  crop_x?: number; title_style?: 'plain' | 'impact' | 'card' | 'comic' | 'neon' | 'arena'
  title_template_version?: 1; title_motion?: boolean; title_scale?: number; title_y?: number; title_accent?: string | null
...
export function portraitDesign(draft: Draft): Draft {
  return {...draft, aspect:'portrait', layout:'crop', crop_x:draft.crop_x ?? .5, title_style:'comic'}
}
