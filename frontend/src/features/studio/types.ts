...
export interface CTA { template: 'off' | 'auto' | 'continue' | 'challenge' | 'brand'; version: 1; brand_layout?: 'classic' | 'poster'; slogan?: string; brand_art?: string | null; logo?: string | null; icon?: string | null; style?: 'glossy' | 'soft' | 'tactical' | 'type'; accent?: string | null; brand: string; text: string; language: 'zh' | 'en' | 'ja'; position: number; confirmed_scene: string }
