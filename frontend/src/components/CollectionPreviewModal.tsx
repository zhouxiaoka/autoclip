...
const CollectionPreviewModal: React.FC<CollectionPreviewModalProps> = ({
  ...
  const handleDragEnd = async (result: DropResult) => {
    ...
    try {
      ...
      hideLoading()
      message.error('Failed to update clip order')
    } finally {
      setIsUpdating(false)
    }
  }
        ...
        <div className="preview-header">
          <div className="header-left">
            ...
            <Text style={{ color: 'var(--ac-sub)', fontSize: '13px' }}>
              ({collectionClips.length} {collectionClips.length === 1 ? 'clip' : 'clips'})
            </Text>
          </div>
            ...
            <Space>
              ...
              {onDelete && (
                <Popconfirm
                  ...
                  description="Delete this collection? This cannot be undone."
                ...
                <div className="video-container">
                  {currentClip ? (
                    ...
                    <div className="empty-video">
                      ...
                      <Text style={{ color: '#999', marginTop: 16 }}>No video available</Text>
                    </div>
                  )}
                </div>
