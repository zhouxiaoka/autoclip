...
| Opção | Configuração |
| --- | --- |
| Modelos na nuvem | Em Configurações, selecione Qwen, OpenAI, Gemini, Claude ou DeepSeek e informe a chave de API. Endpoints compatíveis aceitam uma Base URL personalizada. |
